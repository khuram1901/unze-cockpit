...
export default function ExecutiveDashboardPage() {
  ...
  async function loadExecutiveData(dateToView: string) {
    ...
    const [
      ...
      supabase.from("production_entries").select("id, plant_id, entry_date, size_category, quantity").lte("entry_date", dateToView),
      supabase.from("dispatch_entries").select("id, plant_id, entry_date, size_category, quantity").lte("entry_date", dateToView),
      supabase.from("breakage_entries").select("id, plant_id, entry_date, size_category, quantity").lte("entry_date", dateToView),
      supabase.from("scrap_processed_entries").select("id, plant_id, entry_date, size_category, quantity").lte("entry_date", dateToView),
      ...
      supabase.from("production_entries").select("id, plant_id, entry_date, size_category, quantity").gte("entry_date", selectedMonthStart).lte("entry_date", selectedMonthEnd),
      supabase.from("dispatch_entries").select("id, plant_id, entry_date, size_category, quantity").gte("entry_date", selectedMonthStart).lte("entry_date", selectedMonthEnd),
      supabase.from("breakage_entries").select("id, plant_id, entry_date, size_category, quantity").gte("entry_date", selectedMonthStart).lte("entry_date", selectedMonthEnd),
    ]);
