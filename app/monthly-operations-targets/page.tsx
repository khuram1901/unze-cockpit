    ...
    return (
      <AuthWrapper>
        <main style={{ padding: mainPadding }}>
          <p style={{ color: SLATE, fontSize: "17px" }}>Loading monthly targets…</p>
        </main>
      </AuthWrapper>
    );
  }
              ...
              <form onSubmit={handleSubmit}>
                <label style={labelStyle}>
                  ...
                  <input
                    ...
                    required
                  />
                  <span style={{ fontSize: "15px", color: SLATE }}>
...
function TargetsTable({ targets, mobile }: { targets: MonthlyTarget[]; mobile: boolean }) {
  if (targets.length === 0) {
    return (
      <p style={{ color: SLATE, fontSize: "17px", marginBottom: "8px" }}>
      ...
      <div style={{ marginBottom: "8px" }}>
        {targets.map((t) => (
          <div key={t.id} style={{
            ...
            <div style={{ fontWeight: 700, fontSize: "17px", color: NAVY }}>{t.plant_name}</div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "4px", marginTop: "6px", fontSize: "15px" }}>
            ...
            <div style={{ fontSize: "16px", fontWeight: 700, color: NAVY, marginTop: "4px" }}>
