...
export function PageHeader({
  ...
  return (
    <div style={{ marginBottom: "16px" }}>
      <h1 style={{ fontSize: "22px", fontWeight: 800, color: COLOURS.NAVY, margin: 0 }}>
        {title}
      </h1>
      {subtitle && (
        <p style={{ color: COLOURS.SLATE, fontSize: "12px", marginTop: "5px" }}>
          {subtitle}
        </p>
      )}
    </div>
...
export function CountCard({
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: "19px", fontWeight: 800, color }}>
