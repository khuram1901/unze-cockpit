...
export const PAGE_REGISTRY: PageCard[] = [
  ...
  { permKey: "can_view_finance_utpl", title: "Guarantees & Pay Orders", subtitle: "Track bid/performance guarantees, facility utilisation", href: "/finance/guarantees", icon: "🔐", group: "Finance" },
  ...
  { permKey: "_calendar", title: "Calendar", subtitle: "Tasks and deadlines view", href: "/calendar", icon: "🗓️", group: "Tasks & Meetings", badgeKey: "calendar" },
  ...
  { permKey: "_my_minutes", title: "My Minutes", subtitle: "Meeting minutes you attended", href: "/my-minutes", icon: "🗒️", group: "Tasks & Meetings", badgeKey: "minutes" },
