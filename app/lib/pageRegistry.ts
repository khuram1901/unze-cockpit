...
export const PAGE_REGISTRY: PageCard[] = [
  ...
  { permKey: "can_view_restaurants_pnl", title: "Restaurants Finance", subtitle: "Baranh, Haute Dolci & K&K Jhang — daily cash positions", href: "/finance/restaurants-daily", icon: "💰", group: "Finance" },
  ...
  { permKey: "can_view_hr_performance", title: "HR Performance", subtitle: "Team and full company performance overview", href: "/department/hr?tab=performance", icon: "📊", group: "My Workspace" },
  ...
  { permKey: "_backups", title: "Data & Backups", subtitle: "Database snapshots and source document archive", href: "/backups", icon: "💾", group: "Settings" },
